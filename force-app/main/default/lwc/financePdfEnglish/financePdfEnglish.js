...
import { OMNIDEF } from './financePdfEnglish_def.js';
import tmpl from './financePdfEnglish.html';
import tmpl_nds from './financePdfEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class financePdfEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
